...
//API SETUP
const API_KEY = "AIzaSyBB-Cnj3MHx944aHjZzqQ_ZN_J4lCj3PcE";
...
//create messages elemmet with dynamic classes and return it
...
//handle enter  key press for sending meaasges
...
//adjust input field height dynamiclly
...
const picker = new EmojiMart.Picker({
    ...
    onClickOutside: (e) => {
        if (e.target.id === "emoji-picker") {  // 🔹 Fixed typo: 'taget' -> 'target'
